import { findHoldReportPages, exportExcel } from '../../api/system';
...
export default {
    ...
    methods: {
        ...
        handleReport(type) {
            ...
            let url = 'controller/holdReport/exportHoldReport?pageNum=' + pageNum + '&pageSize=' + pageSize;
        ...
        queryOrderListPage() {
            ...
            findHoldReportPages(this.pageNum, this.pageSize, bodyParam).then((res) => {
